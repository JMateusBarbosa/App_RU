...
import { View, Text, TouchableOpacity, TextInput, ImageBackground, Image , Modal, StyleSheet, Pressable, Alert  } from 'react-native';
import { styles } from '../styles/stylesCardapio';
    ...
    <Drawer
      ...
      <View style={styles.container}>
        ...
        <View style={styles.squareContainer}>
          <TouchableOpacity style={styles.square} onPress={() => openModal(0, 0)}>
          ...
          <TouchableOpacity style={styles.square} onPress={() => openModal(1, 0)}>
            <View style={styles.greenCircle}>
              <Image
          ...
          <TouchableOpacity style={styles.square} onPress={() => openModal(2, 0)}>
            <View style={styles.greenCircle}>
              <Image
          ...
          <TouchableOpacity style={styles.square} onPress={() => openModal(3, 0)}>
            <View style={styles.greenCircle}>
              <Image
